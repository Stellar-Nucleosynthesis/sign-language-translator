...
def filter_test_keypoints(input_dir, output_dir):
...
if __name__ == '__main__':
    test_input = '/mnt/c/Workstudy/CV/keypoints_test_540'
    test_output = '/mnt/c/Workstudy/CV/keypoints_test_filtered'
    print(f"[INFO] Processing Test dataset...")
    filter_test_keypoints(test_input, test_output)